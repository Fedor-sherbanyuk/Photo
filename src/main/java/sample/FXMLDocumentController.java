...
public class FXMLDocumentController implements Initializable {
    ...
    @FXML private CheckBox tenu;
    @FXML private CheckBox pazmutue;
    @FXML private CheckBox light;
    @FXML private CheckBox innshadow;
    @FXML private Slider sovetFotoEffect;
    @FXML private Slider svetitca;
    @FXML private Slider pazmutueGauss;
    @FXML private Slider pazmutueBloom;
    @FXML private Slider motionRadius;
    @FXML private Slider motionAngle;
    @FXML private Slider bright;
    @FXML private Slider saturation;
    @FXML private Slider ottenok;
